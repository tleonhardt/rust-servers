...
grant all privileges on table ezy_tutor_c6 to tleonha;
grant all privileges on table ezy_course_c6 to tleonha;
grant all privileges on all sequences in schema public to tleonha;;
